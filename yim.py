...
#==================[ RECEIVE_MESSAGE ]===============
        ...
        if op.type == 25:
            ...
            elif msg.text in ["เช็คหหัว้ห้อง"]:
              if msg.toType == 2:
            ...
            #    print "done bc"
                ...
                wait["getmid"]=True
                dz.sendMessage(msg.to,"ส่งคอนแทคที่ต้องการเช็ค")
